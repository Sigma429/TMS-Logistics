...
import com.sigma429.sl.AddressBookFeign;
import com.sigma429.sl.base.AreaDto;
import com.sigma429.sl.common.AreaFeign;
import com.sigma429.sl.dto.AddressBookDTO;
import com.sigma429.sl.enums.AddressBookShowStatus;
...
public class AddressBookServiceImpl implements AddressBookService {
    ...
    public AddressBookVO getById(Long id) {
        ...
        Set<Long> areaSet = new HashSet<>(Arrays.asList(addressBook.getProvinceId(), addressBook.getCityId(),
                addressBook.getCountyId()));
    ...
    public AddressBookVO defaultAddress() {
        ...
        List<AddressBookVO> addressBookVOS =
                page.getItems().stream().filter(v -> v.getIsDefault().equals(1)).collect(Collectors.toList());
