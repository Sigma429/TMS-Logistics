...
public class MQListener {
    ...
    public void listenTransportOrderUpdateStatusMsg(String msg) {
        ...
        List<TransportOrderDTO> list =
                transportOrderFeign.findByIds(transportOrderStatusMsg.getIdList().toArray(String[]::new));
    ...
    public void listenTradeUpdatePayStatusMsg(String msg) {
        ...
        // 只处理支付成功的
        List<TradeStatusMsg> msgList =
                tradeStatusMsgList.stream().filter(v -> v.getStatusCode().equals(TradingStateEnum.YJS.getCode())).collect(Collectors.toList());
    ...
    public void listenTradeUpdateRefundStatusMsg(String msg) {
        ...
        // 只处理需要退款的
        List<TradeStatusMsg> msgList =
                tradeStatusMsgList.stream().filter(v -> v.getStatusCode().equals(RefundStatusEnum.SUCCESS.getCode())).collect(Collectors.toList());
        if (CollUtil.isEmpty(msgList)) {
            return;
        }
