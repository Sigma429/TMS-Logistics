...
import com.sigma429.sl.enums.DriverExceptionEnum;
...
public class DriverJobController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "status", value = "司机任务状态", required = true, dataTypeClass =
                    DriverJobStatus.class),
    })
    ...
    public Long createDriverJob(@PathVariable("transportTaskId") Long transportTaskId,
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "month", value = "月份", example = "2022-07", required = true, dataTypeClass =
                    String.class)
    })
    public DriverJobStatisticsDTO jobMonthlyStatistics(@PathVariable("driverId") String driverId, @PathVariable(
            "month") String month) {
