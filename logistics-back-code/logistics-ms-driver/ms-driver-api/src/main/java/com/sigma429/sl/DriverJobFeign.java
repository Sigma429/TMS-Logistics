...
public interface DriverJobFeign {
    ...
    Long createDriverJob(@PathVariable("transportTaskId") Long transportTaskId,
    ...
    DriverJobStatisticsDTO jobMonthlyStatistics(@PathVariable("driverId") String driverId,
