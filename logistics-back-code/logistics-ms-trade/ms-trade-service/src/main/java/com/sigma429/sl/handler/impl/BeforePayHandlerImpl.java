package com.sigma429.sl.handler.impl;
...
public class BeforePayHandlerImpl implements BeforePayHandler {
    ...
    public RefundRecordEntity idempotentRefundTrading(TradingEntity trading, BigDecimal refundAmount) {
        // 查询退款次数，不能大于20次
        List<RefundRecordEntity> recordList =
                refundRecordService.findListByTradingOrderNo(trading.getTradingOrderNo());
        ...
        // 退款单号
        refundRecord.setRefundNo(Convert.toLong(identifierGenerator.nextId(refundRecord)));
