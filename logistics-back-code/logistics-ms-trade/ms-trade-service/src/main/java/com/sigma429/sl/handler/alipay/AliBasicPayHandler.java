...
public class AliBasicPayHandler implements BasicPayHandler {
    ...
    public Boolean queryTrading(TradingEntity trading) throws SLException {
        ...
        try {
            ...
            log.error(msg, e);
            throw new SLException(msg, TradingEnum.NATIVE_QUERY_FAIL.getCode(),
        ...
        if (success) {
            ...
            } else if (StrUtil.equalsAny(tradeStatus, TradingConstant.ALI_TRADE_SUCCESS,
                    TradingConstant.ALI_TRADE_FINISHED)) {
        ...
        throw new SLException(trading.getResultJson(), TradingEnum.NATIVE_QUERY_FAIL.getCode(),
                TradingEnum.NATIVE_QUERY_FAIL.getStatus());
    }
    ...
    public Boolean refundTrading(RefundRecordEntity refundRecord) throws SLException {
        ...
        try {
            ...
            log.error(msg, e);
            throw new SLException(msg, TradingEnum.NATIVE_REFUND_FAIL.getCode(),
                    TradingEnum.NATIVE_REFUND_FAIL.getStatus());
        }
        ...
        throw new SLException(refundRecord.getRefundMsg(), TradingEnum.NATIVE_REFUND_FAIL.getCode(),
                TradingEnum.NATIVE_REFUND_FAIL.getStatus());
    }
