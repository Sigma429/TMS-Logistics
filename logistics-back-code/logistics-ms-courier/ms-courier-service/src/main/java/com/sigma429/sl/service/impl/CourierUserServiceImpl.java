...
/**
 * ClassName:CourierUserServiceImpl
 * Package:com.sigma429.sl.service.impl
 * Description:
 * @Author:14亿少女的梦-Sigma429
 * @Create:2024/03/24 - 17:07
 * @Version:v1.0
 */
@Service
@Slf4j
public class CourierUserServiceImpl implements CourierUserService {
     ...
     */
    @Override
    public List<Long> queryCourierIdListByCondition(Long agencyId, Double longitude, Double latitude,
        ...
        if (CollUtil.isNotEmpty(serviceScopeDTOS)) {
            ...
            workSchedulingDTOS = workSchedulingFeign.monthSchedule(bidStr, agencyId,
        ...
        workSchedulingDTOS = workSchedulingFeign.monthSchedule(null, agencyId, WorkUserTypeEnum.COURIER.getCode(),
                estimatedEndTime);
