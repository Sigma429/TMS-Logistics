...
public class TransportOrderTaskServiceImpl extends
    ...
    public IPage<TransportOrderTaskEntity> findByPage(Integer page, Integer pageSize, String transportOrderId,
        ...
        lambdaQueryWrapper.like(ObjectUtil.isNotEmpty(transportOrderId),
                TransportOrderTaskEntity::getTransportOrderId, transportOrderId);
        lambdaQueryWrapper.like(ObjectUtil.isNotEmpty(transportTaskId), TransportOrderTaskEntity::getTransportTaskId,
                transportTaskId);
    ...
    public void del(String transportOrderId, Long transportTaskId) {
        ...
        LambdaQueryWrapper<TransportOrderTaskEntity> lambdaQueryWrapper = new LambdaQueryWrapper<>();
        lambdaQueryWrapper.eq(ObjectUtil.isNotEmpty(transportOrderId), TransportOrderTaskEntity::getTransportOrderId,
                transportOrderId);
        lambdaQueryWrapper.eq(ObjectUtil.isNotEmpty(transportTaskId), TransportOrderTaskEntity::getTransportTaskId,
                transportTaskId);
