...
import com.sigma429.sl.service.BaseTruckService;
import com.sigma429.sl.vo.R;
import com.sigma429.sl.vo.baseTruck.BindingTrucksVO;
import com.sigma429.sl.vo.baseTruck.TransportTripsUpdateVO;
import com.sigma429.sl.vo.baseTruck.TransportTripsVO;
import com.sigma429.sl.vo.baseTruck.TruckVO;
...
public class TruckTripsController {
    ...
    public R<TransportTripsUpdateVO> updateTransportTrips(@PathVariable(name = "id") Long id,
                                                          @RequestBody TransportTripsUpdateVO vo) {
    ...
    public R<List<TransportTripsVO>> findAllTransportLineTrips(@RequestParam(name = "transportLineId", required =
            false) Long transportLineId) {
    ...
    public R<Void> saveTransportTripsTruck(@PathVariable(name = "id") Long id,
                                           @RequestBody BindingTrucksVO bindingTrucksVO) {
        // 保存车辆安排信息
