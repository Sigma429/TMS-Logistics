...
import com.sigma429.sl.CostConfigurationFeign;
...
import com.sigma429.sl.trips.TripsFeign;
import com.sigma429.sl.truck.TruckTripsDto;
import com.sigma429.sl.util.PageResponse;
import com.sigma429.sl.vo.transportLine.TransportLineQueryVO;
import com.sigma429.sl.vo.transportLine.TransportLineVO;
...
public class TransportServiceImpl implements TransportService {
    ...
    public PageResponse<TransportLineVO> findTransportLineByPage(TransportLineQueryVO transportLineQueryVO) {
        PageResponse<TransportLineDTO> transportLineDtoPage =
                transportLineFeign.queryPageList(BeanUtil.toBean(transportLineQueryVO, TransportLineSearchDTO.class));
        // 加工数据
