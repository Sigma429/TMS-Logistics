...
public class UserController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "year", value = "年份", required = true, example = "2022", dataTypeClass =
                    String.class),
            @ApiImplicitParam(name = "month", value = "月份", required = true, example = "07", dataTypeClass =
                    String.class)
    })
