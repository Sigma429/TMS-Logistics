...
public class MessageController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "contentType", value = "消息类型，200：司机端公告，201：司机端系统通知", required = true,
                    dataTypeClass = Integer.class),
            @ApiImplicitParam(name = "page", value = "页码", example = "1", required = true, dataTypeClass =
                    Integer.class),
            @ApiImplicitParam(name = "pageSize", value = "页面大小", example = "10", required = true, dataTypeClass =
                    Integer.class)
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "contentType", value = "消息类型，200：司机端公告，201：司机端系统通知;特别的，0代表查询全部未读", defaultValue
                    = "0", required = true, dataTypeClass = Integer.class)
    })
