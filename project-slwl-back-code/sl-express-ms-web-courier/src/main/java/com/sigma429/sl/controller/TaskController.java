...
public class TaskController {
    ...
    @ApiOperation("获取任务详情")
    @GetMapping("/get/{id}")
    @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "派件或取件id", required = true, dataTypeClass =
            String.class)})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "transportOrderId", value = "运单号", required = true, dataTypeClass =
            String.class)})
