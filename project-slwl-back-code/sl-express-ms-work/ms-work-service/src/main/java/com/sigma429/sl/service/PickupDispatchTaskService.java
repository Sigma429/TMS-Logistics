...
public interface PickupDispatchTaskService extends IService<PickupDispatchTaskEntity> {
     ...
     * @return 任务数
     */
    List<CourierTaskCountDTO> findCountByCourierIds(List<Long> courierIds,
     ...
     * @return 任务数量
     */
    Integer todayTasksCount(Long courierId, PickupDispatchTaskType taskType, PickupDispatchTaskStatus status,
     ...
     * @return 取派件任务列表
     */
    List<PickupDispatchTaskDTO> findAll(Long courierId, PickupDispatchTaskType taskType,
                                        PickupDispatchTaskStatus taskStatus, PickupDispatchTaskIsDeleted isDeleted);
