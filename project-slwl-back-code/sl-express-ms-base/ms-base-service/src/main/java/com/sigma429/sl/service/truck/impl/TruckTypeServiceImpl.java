...
import com.sigma429.sl.mapper.truck.TruckTypeMapper;
import com.sigma429.sl.service.truck.TruckService;
import com.sigma429.sl.service.truck.TruckTypeService;
...
public class TruckTypeServiceImpl extends ServiceImpl<TruckTypeMapper, TruckTypeEntity>
     ...
     */
    @Override
    public IPage<TruckTypeEntity> findByPage(Integer page, Integer pageSize, String name, BigDecimal minAllowableLoad
            , BigDecimal maxAllowableLoad, BigDecimal minAllowableVolume, BigDecimal maxAllowableVolume, Long id) {
    ...
    public void disable(Long id) {
        Long count =
                truckService.getBaseMapper().selectCount(Wrappers.<TruckEntity>lambdaQuery().eq(TruckEntity::getTruckTypeId, id));
        if (count > 0) {
