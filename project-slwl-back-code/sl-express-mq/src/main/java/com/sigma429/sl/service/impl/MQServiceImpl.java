...
import com.sigma429.sl.exception.MsgException;
...
public class MQServiceImpl implements MQService {
    ...
    public Boolean sendMsg(String exchange, String routingKey, Object msg) {
        // 实时发送
        return sendMsg(exchange, routingKey, msg, Constants.MQ.DEFAULT_DELAY);
    }
        ...
        correlationData.getFuture().addCallback(
                result -> {
                    if (result.isAck()) {
                        ...
                        failMsgService.save(failMsgEntity);
                    }
                },
                ex -> {
    ...
    public Boolean saveFailMag(MsgException msgException) {
        ...
        failMsgService.save(msgException.getFailMsgEntity());
        return true;
    }
