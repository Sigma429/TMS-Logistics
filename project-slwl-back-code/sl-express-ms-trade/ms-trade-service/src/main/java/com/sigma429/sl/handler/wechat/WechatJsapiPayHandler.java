...
import com.sigma429.sl.handler.wechat.bean.JsapiPayParam;
    ...
    public void createJsapiTrading(TradingEntity tradingEntity) {
        ...
        Map<String, Object> params = MapUtil.<String, Object>builder()
                ...
                .put("amount", MapUtil.<String, Object>builder()
                        // 金额，单位：分
                        .put("total", Convert.toInt(NumberUtil.mul(tradingEntity.getTradingAmount(), 100)))
                        // 人民币
                        .put("currency", "CNY")
                        .build())
                .put("payer", MapUtil.<String, Object>builder()
                        // 用户识别标识
                        .put("openid", tradingEntity.getOpenId())
                        .build())
                .build();
        try {
