...
public class PayChannelController {
    ...
    public PageResponse<PayChannelDTO> findPayChannelPage(
        ...
        Page<PayChannelEntity> payChannelVoPage = payChannelService.findPayChannelPage(payChannelDTO, pageNum,
                pageSize);
    ...
    public void createPayChannel(@RequestBody PayChannelDTO payChannelDTO) {
        PayChannelEntity payChannel = payChannelService.createPayChannel(payChannelDTO);
        if (payChannel != null) {
            return;
        }
    ...
    public void updatePayChannel(@RequestBody PayChannelDTO payChannelDTO) {
        Boolean flag = payChannelService.updatePayChannel(payChannelDTO);
        if (flag) {
            return;
        }
    ...
    public void deletePayChannel(@RequestBody PayChannelDTO payChannelDTO) {
        ...
        Boolean flag = payChannelService.deletePayChannel(checkedIds);
        if (flag) {
            return;
        }
